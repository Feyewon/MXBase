...
#import "MXEdgeInsetsButton.h"

@implementation MXEdgeInsetsButton
...
- (void)setEdgeInsetsStyle:(MXButtonEdgeInsetsStyle)edgeInsetsStyle {
    ...
    switch (edgeInsetsStyle) {
        case MXButtonEdgeInsetsStyleImageRight:
        {
            space = space * 0.5;
        ...
        case MXButtonEdgeInsetsStyleImageLeft:
        {
            space = space * 0.5;
            ...
            break;
        case MXButtonEdgeInsetsStyleImageBottom:
        {
            ...
            break;
        case MXButtonEdgeInsetsStyleImageTop:
        {
            CGFloat imageHeight = CGRectGetHeight(self.imageView.frame);
            CGFloat labelHeight = CGRectGetHeight(self.titleLabel.frame);
            CGFloat buttonHeight = CGRectGetHeight(self.frame);
